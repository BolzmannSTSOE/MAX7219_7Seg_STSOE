...
namespace MAX7219_7Seg {
  ...
  let _SEGMENTS = [0x7E, 0x30, 0x6D, 0x79, 0x33, 0x5B, 0x5F, 0x70, 0x7F, 0x7B, 0x77, 0x1F, 0x4E, 0x3D, 0x4F, 0x47];
	...
	*/
        ...
        //% parts="MAX7219_7Seg" num.dflt=1273
		showNumber(num: number) {
			if (isNaN(num) || num === null || num === undefined || Number.isNaN(num)) {
				this._errorHandling();
				return;
			}
	...
	*/
    ...
    /**
     * Parse text in formats and convert to numbers:
     * - 0xA7F...  (hex, only 0-9/A-F/a-f, NO negative allowed, if too many hex digits -> last allowed digits used)
     * Returns -1 on invalid input.
     */
